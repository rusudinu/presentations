...
\begin{frame}[eyebrow=Git]{Create a GitHub account before Lab 1}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.41\textwidth}
      \kv{Shared course material}{\link{https://github.com/rusudinu/mobile-and-embedded-computing}{github.com/rusudinu/\\mobile-and-embedded-computing}}
      \vskip 3mm
...
\begin{frame}[eyebrow=Git]{What happens after the merge}
  ...
  \end{takeaway}
  \note{Keep this short: the full pipeline comes back in Lecture 14. The idea students need now is that a pull request runs checks automatically, and a red check is not someone else's problem.}
\end{frame}
...
\end{shell}
    \end{column}
    \begin{column}{0.42\textwidth}
      \kv{Course material}{\link{https://github.com/rusudinu/mobile-and-embedded-computing}{github.com/rusudinu/\\mobile-and-embedded-computing}}
      \vskip 2.5mm
