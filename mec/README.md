...
Course brief. Every lecture and lab deck in this folder is written from the section below that
names it, following `template/AUTHORING.md`. Paths below are relative to
