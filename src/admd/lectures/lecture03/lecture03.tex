...
\begin{frame}[eyebrow=Scrolling]{Choosing a scrolling widget}
  ...
  \note{Point at the fifth row and say that CustomScrollView looks intimidating and is mostly a list of the widgets they already know, prefixed with Sliver. Lecture 13 comes back to it for the polish pass.}
\end{frame}
...
\begin{frame}[eyebrow=Material]{AppBar, buttons and navigation bars}
  ...
  \begin{grid}[3]
    ...
    \cell[\faIcon{palette}]{ThemeData}{Colors and typography come from the theme, not from each widget. Lecture 13 goes deeper.}
  \end{grid}
