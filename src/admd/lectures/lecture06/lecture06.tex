...
\begin{frame}[eyebrow=Testing]{What to test at each layer}
  ...
  \end{takeaway}
  \note{Widget testing gets a full treatment in Lecture 13. Today they only need to know that a bloc test is a plain Dart test, and that the fake repository is a hand-written class, not a generated mock.}
\end{frame}
