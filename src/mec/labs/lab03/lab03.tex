...
\begin{frame}[embedded,eyebrow=Troubleshooting]{The peripheral side}
  ...
  \trouble{tinygo flash: unknown target}{Use the SoftDevice target of your board, pca10056-s140v7 on the nRF52840 development kit.}
  \trouble{Nothing works on an ESP32}{Only the ESP32-C3 and ESP32-S3 work, through espradio. Otherwise use the nRF52840 or a laptop.}
\end{frame}
