...
\end{golang}
    ...
    \begin{column}{0.40\textwidth}
      \begin{itemize}
        ...
        \item Passing \code{id} as an argument avoids every goroutine capturing the same loop variable.
      \end{itemize}
    \end{column}
  \end{columns}
...
\end{golang}
    ...
    \begin{column}{0.40\textwidth}
      \begin{itemize}
        ...
        \item Dart has no direct equivalent: the closest is racing two Futures with a library helper.
      \end{itemize}
    \end{column}
  \end{columns}
