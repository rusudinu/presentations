...
\objectivesframe{
  \cell[\faClock]{Order events}{Why a wall clock cannot order two edits, and what a Lamport or vector clock gives you instead.}
...
\begin{frame}[eyebrow=Conflicts]{Where conflicts come from}
  \vskip 3mm
  \begin{columns}[T]
...
\begin{frame}[eyebrow=Conflicts]{What ordering we need}
  \vskip 2mm
  \begin{grid}[3]
...
% =====================================================================
\divider{Part 3 · Strategies}{Four ways to resolve}[Each one loses something. Decide what, in advance and in writing]

\begin{frame}[eyebrow=Strategies]{Four strategies, ranked}
  \vskip 1mm
  {\usebeamerfont{small}
