...
\divider{Part 4 \textperiodcentered\ API design for a mobile client}{Design decisions clients feel}[Pagination, versioning, conditional requests, compression, and rate limits]
