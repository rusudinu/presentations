...
\objectivesframe{
  ...
  \cell[\faCode]{Call all four shapes}{Unary, server streaming, client streaming and bidirectional, and know which one a screen needs.}
  ...
  \cell[\faClock]{Survive the network}{Deadlines, cancellation and the radio tail on a mobile client.}
}

\begin{frame}[eyebrow=Overview]{What gRPC is}
  \vskip 3mm
  \begin{grid}[4]
...
\divider{Part 3 · The wire}{What travels, and how it changes}[Protobuf's size on the wire, and evolving a schema safely]
