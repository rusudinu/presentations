...
\objectivesframe{
  ...
  \cell[\faLayerGroup]{Read the three trees}{Widget, Element and RenderObject, and how reconciliation decides what a rebuild touches.}
  \cell[\faBolt]{Cut costs}{const constructors, builder lists, and when an offscreen buffer or a decoded image is the problem.}
...
\begin{frame}[eyebrow=Rendering]{What setState does}
  \begin{columns}[T]
    \begin{column}{0.56\textwidth}
      \begin{itemize}
...
\begin{frame}[eyebrow=Rendering]{What each operation costs}
  \vskip 1mm
...
\begin{frame}[eyebrow=Profiling]{Which half of the bar: UI or raster}
  \vskip 1mm
...
\begin{frame}[fragile,eyebrow=Profiling]{After: the fix, and what moved}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
\begin{dart}
ListView.builder(
