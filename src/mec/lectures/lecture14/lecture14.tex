...
\objectivesframe{
  ...
  \cell[\faGraduationCap]{Prepare for the exam}{The exam format, what to revise per lecture, the project defense, and the concept presentation.}
}
...
\begin{frame}[fragile,eyebrow=Compilation]{Dart uses both, through build modes}
  \vskip 2mm
  \begin{columns}[T]
