...
\subtitle{Debugging, Stateless vs Stateful, and state placement}
...
\divider{Part 1 · Debugging}{Debugging}[DevTools, breakpoints, and useful logging]
...
\begin{frame}[eyebrow=State]{Tools for shared state}
  \vskip 1mm
...
\begin{frame}[eyebrow=Numbers]{The frame budget}
  \vskip 4mm
  \begin{grid}[3]
